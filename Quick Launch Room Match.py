...
def setup_matchmaking(target_path, gameVersion):
    ...
    # <game>/ReBalanceOfSouls/ rather than compiled in. A missing plugin
    # fails as ABSENCE -- the character is simply not there -- so this is
    # loud, and MIRRORED so no stale plugin patches the exe beside its
    # replacement.
    try:
